...
ggplot(df, aes(x, y)) +
    ...
    geom_segment(aes(x = 2, xend = 2, y = 4, yend = 6), color = 'skyblue', lty = 'dashed') +
    geom_segment(aes(x = 4, xend = 4, y = 2, yend = 4), color = 'skyblue', lty = 'dashed') +
    geom_segment(aes(x = 2, xend = 4, y = 4, yend = 4), color = 'skyblue', lty = 'dashed') +
    geom_segment(aes(x = 4, xend = 6, y = 2, yend = 2), color = 'skyblue', lty = 'dashed') +
    geom_segment(aes(x = 2, xend = 2, y = 2, yend = 6), color = 'red', lty = 'dotted') +
    geom_segment(aes(x = 2, xend = 6, y = 2, yend = 2), color = 'red', lty = 'dotted') +
    geom_path(color = 'red', lty = 'dotted') +
    geom_segment(aes(x = 2, xend = 4, y = 6, yend = 8), color = 'skyblue', lty = 'dashed') +
    geom_segment(aes(x = 4, xend = 6, y = 4, yend = 6), color = 'skyblue', lty = 'dashed') +
    geom_segment(aes(x = 6, xend = 8, y = 2, yend = 4), color = 'skyblue', lty = 'dashed') +
    geom_segment(aes(x = 4, xend = 6, y = 8, yend = 6), color = 'skyblue', lty = 'dashed') +
    geom_segment(aes(x = 6, xend = 8, y = 6, yend = 4), color = 'skyblue', lty = 'dashed') +
    ...
    annotate('text', x = 4, y = 6, label = expression(A^2 + B^2 == C^2), cex = 1.5) +
    annotate('text', x = 6, y = 4, label = expression(B^2 + A^2 == C^2), cex = 1.5) +
    annotate('text', x = 3, y = 4, label = expression(A), cex = 1.5) +
    annotate('text', x = 4, y = 3, label = expression(B), cex = 1.5) +
    annotate('text', x = 1.75, y = 4, label = expression(2 * A), cex = 1.5) +
    annotate('text', x = 4, y = 1.75, label = expression(2 * B), cex = 1.5) +
    annotate('text', x = 10, y = 10, label = expression((2*A[i])^2 + (2*B)^2 == (C^2)^2), cex = 1.5) +
    annotate('text', x = 6.5, y = 6.5, label = expression((2*B[i])^2 + (2*A)^2 == (C^2)^2), cex = 1.5) +
    coord_fixed(1) +
    xlab("J1") +
    ylab("J2") +
