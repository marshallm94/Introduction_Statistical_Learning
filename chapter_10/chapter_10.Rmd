...
\frac{1}{2}\sum_{i,i' \in C_k}\sum_{j=1}^P x_{i,j}^2 - \frac{2}{2\lvert C_k \rvert}\sum_{i,i' \in C_k}\sum_{j=1}^P x_{i',j}x_{i,j} + \frac{1}{2}\sum_{i,i' \in C_k}\sum_{j=1}^P x_{i',j}^2 = \\
\frac{1}{2}\sum_{i,i' \in C_k}\sum_{j=1}^P x_{i,j}^2 - \frac{1}{\lvert C_k \rvert}\sum_{i,i' \in C_k}\sum_{j=1}^P x_{i',j}x_{i,j} + \frac{1}{2}\sum_{i,i' \in C_k}\sum_{j=1}^P x_{i',j}^2 = \\
