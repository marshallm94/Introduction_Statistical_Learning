...
* **A**. In the plots below, the log of the RSS, $Adj.~R^2$, Cp and BIC are plotted in the same image. All images show a leveling off around teh 5 variable model. One could make the case for the 6 variable model, however I believe the (albiet) slight increase in complexity is not worth the marginal increase in predictive power. The final model coefficients are printed below.
