...
* **D**. The blanket statement that QDA will outperform LDA, or more generally, more flexible methods will outperform less flexible methods **all** the time is false. QDA will have a lower test error rate *when it doesn't overfit the data*. As stated in my previous answer, if the sample size is small, the QDA is likely to overfit the data, and therefore have an inferior test error rate that LDA.