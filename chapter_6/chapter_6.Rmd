...
With regard to linear regression, $\mu$ is the linear combination of each $\beta_j$ and $x_{i,j}$, $\theta = \beta$, and $x$ in the Gaussian PDF is $y_i$. In addition, maximum likelihood takes the maximum of the *log* likelihood. Therefore, the above equation becomes:
