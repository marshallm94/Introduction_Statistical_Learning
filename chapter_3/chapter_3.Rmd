...
* *ii*
All variables except acceleration, horsepower and cylinders have statistically significant relationships with the response.
...
**B**.
The coefficient $\hat{\beta}$ when $Y$ is regressed onto $X$ is 4.85 which does not equal the coefficient $\hat{\beta}$ when $X$ is regressed onto $Y$.
